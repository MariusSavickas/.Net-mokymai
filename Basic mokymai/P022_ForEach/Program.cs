...
namespace P022_ForEach
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            var rez = IsmetytiZodzius("Labas as esu Kodelskis ir labai megstu programuoti");
        ...
        private static void PavyzdiniaiForEach()
        {
            ...
            List<int> amziai = new List<int> { 1, 2, 3 };
            ...
            foreach (var vardas in vardai)
            {
                foreach (var amzius in amziai)
                {
                    Console.WriteLine($"vardas {vardas} ir amzius {amzius} ");
                }
            }
            ...
            {
                if (raide == 'x') { Console.Write(raide); }
                Console.Write(raide);
            }
        ...
        public static int ApskaiciuotiVidurki(List<int> skaiciai)
        {
            var vidurkis = 0;
        ...
        /// <summary>        ///  Parašyti metodą IstrauktiSkaicius, kuris priima teksta, bet grazina tik skaicius egzistuojancius paciame tekste.       
        ...
        {
            var sakinoKonstruktorius = new StringBuilder();
            ...
            foreach (var zodis in zodziai)
            {
                sakinoKonstruktorius.Append(zodis + " ");
            }

            Console.WriteLine(sakinoKonstruktorius.ToString());
            return zodziai;
        }


        /*
        Parašyti metodą SukonstruotiKalade(rusis, kortos). 
        ...
        */
        ...
        public static void AtspaudintiKalade(List<string> kalade)
        {
