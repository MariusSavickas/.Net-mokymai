namespace Super_Skaiciuotuvas
{
    public class Program
    {
        static void Main(string[] args)
        {
            Console.WriteLine("Hello, Super Skaičiuotuvas \n");
            string pasirinkimas1 = string.Empty;
            Meniu();

            Console.WriteLine("Iveskite savo pasirinkimą");
            pasirinkimas1 = Console.ReadLine();
            MeniuPasirinkimas( pasirinkimas1);
...
2. Išeiti iš programos");
        ...
        public static string MeniuPasirinkimas(string pasirinkimas1)
        {
            switch (pasirinkimas1)
            {
                case "1":
                 return   MatematinisVeiksmas();
                case "2":
        ...
        private static string  MatematinisVeiksmas()
        {
            return "Labas";
        }
    }
